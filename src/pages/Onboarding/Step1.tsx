...
import SignupErrorMessage from "../../components/Signup/SignupErrorMessage";
        ...
        <div className="flex items-center gap-4 mb-2">
          <div className="relative">
            <div className="w-20 h-20 rounded-full bg-grayscale-300 overflow-hidden">
              {(previewURL || imageURL) && (
                <img src={previewURL || imageURL || ""} alt="profile" className="w-full h-full object-cover" />
              )}
            </div>
            <button
              type="button"
            ...
            <input ref={fileRef} type="file" accept="image/*" className="hidden" onChange={handleFile} onClick={(e) => (e.currentTarget.value = "")} />
          </div>
