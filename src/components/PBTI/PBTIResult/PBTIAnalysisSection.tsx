const PBTIAnalysisSection = () => (
  <div className="bg-white rounded-2xl p-5 shadow mb-6">
    ...
    <ul className="text-body4 space-y-2">
      ...
      <li>커피 내리는 중간에 즉흥 터치업 ➔ 감각형(S) – 실제의 감각 자극에 민감, 순간의 기분을 살리는 향 선호</li>
      <li>TV 광고 직후 확실히 분사 ➔ 외향형(E) – 향기를 통해 긍정적 인상을 남기고 싶어함</li>
      <li>설거지 시작 전 공간 전체 분사 ➔ 전통적 안정형 – 실패 없는 클래식 스타일과 견고한 밸런스를 중시</li>
    </ul>
  </div>
);
