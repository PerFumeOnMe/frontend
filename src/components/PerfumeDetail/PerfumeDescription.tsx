...
const PerfumeDescription = () => {
  return (
    <div className="w-full h-full flex flex-col gap-12 bg-[#FBFBFB]/20 border border-white shadow-[0_-10px_10px_-3px_rgba(0,0,0,0.05),0_10px_10px_-3px_rgba(0,0,0,0.05)] pt-5 pb-5 pl-8 pr-8">
